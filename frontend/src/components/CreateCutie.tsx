...
export function CreateCutie() {
    ...
    return (
        ...
        <form className="flex-col flex justify-between items-center gap-3  relative" onSubmit={handleSubmit(onSubmit)}>
            ...
            {errors.name && <div
                className="absolute -top-[2.8rem] transition-all duration-300 ease-linear bg-neutral-800 p-2 rounded-lg">Name
                plz :C</div>}
            <div className="content__item cursor-pointer">
                <a href="#" className="link link--iocaste">
                    <button type="submit">Submit</button>
                    <svg className="link__graphic link__graphic--slide" width="300%" height="100%" viewBox="0 0 1200 60"
